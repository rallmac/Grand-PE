...
export default function Cart() {
  return (
    <div className="flex min-h-screen items-center justify-center bg-white px-4 py-8 sm:px-6 sm:py-12">
      ...
      {/* CARD */}
      <div className="w-full max-w-2xl bg-white rounded-3xl shadow-sm p-4 sm:p-6">

        {/* HEADER */}
        <h2 className="text-xl sm:text-2xl font-bold text-[#265073] text-center">
          Shopping Cart
        </h2>
          ...
          {products.map((product) => (
            ...
            >
              ...
              <img
                ...
                alt={product.name}
                className="w-full sm:w-20 h-40 sm:h-20 object-cover rounded-md border border-gray-200"
              />
              ...
              <div className="flex flex-1 flex-col justify-between">
                ...
                {/* PRICE */}
                <p className="text-[#265073] font-semibold mt-2 sm:mt-0">
                  {product.price}
                </p>
        ...
        <div className="mt-6 border-t border-gray-200 pt-6">
          ...
          <div className="flex justify-between text-gray-900 font-medium text-sm sm:text-base">
            <span>Subtotal</span>
            <span>$262.00</span>
          </div>
          ...
          {/* CHECKOUT BUTTON */}
          <button className="mt-6 w-full bg-[#265073] hover:bg-[#1f3e59] transition text-white py-2.5 sm:py-3 rounded-md font-medium text-sm sm:text-base">
            Checkout
          </button>
